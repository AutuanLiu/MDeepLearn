...
"""
-------------------------------------------------
   File Name： fashion_mnist_simple
   Description :  fashion mnist example
...
# prepare data
X_train, y_train, X_val, y_val, X_test, y_test = tl.files.load_fashion_mnist_dataset(shape=(-1, 784), path="../datasets/tldata")
# define placeholder
